...
The component is really similar to the [Simple Marquee Component](https://component.imoogleai.xyz/docs/components/blocks/simple-marquee), and has the same features and props (and a bit more:)):
